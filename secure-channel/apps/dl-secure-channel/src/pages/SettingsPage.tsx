      ...
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
        <div>
          ...
          <p className="text-sm text-dl-text-dim mt-1">
            Configure Ridgeline privacy and direct-message security.
          </p>
        </div>
        ...
        <div className="dl-card text-xs text-dl-muted space-y-1">
          <p><strong>Note:</strong> Preferences are stored locally; encrypted preference storage is not yet deployed.</p>
