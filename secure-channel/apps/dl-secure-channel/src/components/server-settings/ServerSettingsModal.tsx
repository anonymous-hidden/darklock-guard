...
export default function ServerSettingsModal() {
  ...
  console.log('[SERVER_SETTINGS_RENDERED]');
              ...
              <div className="flex-1 overflow-y-auto px-10 pb-10 overscroll-contain">
                {isLocalGroup ? (
                  <div className="flex flex-col items-center justify-center h-full gap-3 text-white/30">
                    ...
                    <p className="text-xs text-center max-w-xs">This is a local group. Group messaging is paused; server settings are available only for network servers created through IDS.</p>
                    <button
                      onClick={closeServerSettings}
