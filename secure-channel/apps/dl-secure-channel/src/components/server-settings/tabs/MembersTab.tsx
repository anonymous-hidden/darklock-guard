...
export default function MembersTab({ serverId }: { serverId: string }) {
  ...
  const handleAssign = async (userId: string, roleId: string) => {
    ...
    try {
      ...
      console.error("[MembersTab] assignRole failed:");
  ...
  const handleRemoveRole = async (userId: string, roleId: string) => {
    ...
    try {
      ...
      console.error("[MembersTab] removeRole failed:");
      setActionError(String(e));
    }
  };
  ...
  const handleKick = async (userId: string) => {
    ...
    try {
      ...
      console.error("[MembersTab] kick failed:");
      setActionError(String(e));
      setConfirmKickId(null);
    }
  };
  ...
  const handleTimeout = useCallback(async () => {
    ...
    try {
      ...
      console.log('[MEMBER_TIMEOUT_REQUESTED]');
  ...
  const handleWarn = useCallback(async () => {
    ...
    try {
      ...
      console.log('[MEMBER_WARNING_REQUESTED]');
      setWarnModal(null);
      setWarnReason("");
    } catch (e) {
      setActionError(String(e));
  ...
  const handleBan = useCallback(async () => {
    ...
    try {
      ...
      console.log('[MEMBER_BAN_REQUESTED]');
      setBanModal(null);
      setBanReason("");
    } catch (e) {
      setActionError(String(e));
