...
rolesRouter.get('/:sid/roles', requireAuth, (req, res) => {
  try {
    ...
    console.log('[IDS_ROLE_LIST_REQUESTED]');
    ...
    if (!membership) {
      console.warn('[IDS_ROLE_LIST_FORBIDDEN]');
    ...
    console.error('List roles error:');
...
rolesRouter.post('/:sid/roles', requireAuth, (req, res) => {
  try {
    ...
    try {
      ...
      console.warn('[IDS] role.created broadcast failed:');
    }
...
rolesRouter.put('/:sid/roles/reorder', requireAuth, (req, res) => {
  try {
    ...
    console.error('Reorder roles error:');
...
rolesRouter.get('/:sid/channels/:cid/overrides', requireAuth, (req, res) => {
  try {
    ...
    console.error('List overrides error:');
...
rolesRouter.delete('/:sid/channels/:cid/overrides/:rid', requireAuth, (req, res) => {
  try {
    ...
    console.error('Delete override error:');
