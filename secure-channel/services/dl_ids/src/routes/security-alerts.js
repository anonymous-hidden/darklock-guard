...
securityAlertRouter.post('/:id/security/alerts',
  ...
  (req, res) => {
    try {
      ...
      console.error('[security-alerts] POST error:');
...
securityAlertRouter.get('/:id/security/alerts',
  ...
  (req, res) => {
    try {
      ...
      console.error('[security-alerts] GET error:');
      res.status(500).json({ error: 'Internal server error' });
    }
  }
);
...
securityAlertRouter.patch('/:id/security/alerts/:alertId',
  ...
  (req, res) => {
    try {
      ...
      console.error('[security-alerts] PATCH error:');
      res.status(500).json({ error: 'Internal server error' });
    }
  }
);
...
securityAlertRouter.get('/:id/security/audit',
  ...
  (req, res) => {
    try {
      ...
      console.error('[security-audit] GET error:');
      res.status(500).json({ error: 'Internal server error' });
    }
  }
);
