...
function dashboard() {
    return {
        ...
        // Initialize
        init() {
            console.log('=ƒÜÇ Dashboard initialized');
            this.loadData();
        },
        ...
        // Actions
        lockdownServer() {
            alert('=ƒöÆ Server lockdown activated!');
        },
        
        pauseInvites() {
            alert('GÅ+n+Å Invites paused!');
        },
        
        clearRaidFlags() {
            alert('=ƒº¦ Raid flags cleared!');
        },
        
        emergencyMode() {
            alert('=ƒÜ¿ Emergency mode activated!');
        },
        
        toggleAutoRefresh() {
            alert('=ƒöä Auto-refresh toggled!');
        },
        ...
        // Methods
        async init() {
            console.log('=ƒÜÇ Dashboard initializing...');
            try {
                ...
                console.log('G£à Dashboard initialized successfully');
                ...
                console.error('G¥î Dashboard initialization failed:', error);
            }
        },
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    this.showNotification(
                        this.lockdownMode ? '=ƒöÆ Server lockdown activated' : '=ƒöô Server lockdown deactivated',
                ...
                this.showNotification('G¥î Failed to toggle lockdown', 'error');
            } finally {
        ...
        async pauseInvites() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    this.showNotification(
                        this.invitesPaused ? 'GÅ+n+Å Invites paused' : 'Gû¦n+Å Invites resumed',
                        'info'
                    );
                } else {
                ...
                this.showNotification('G¥î Failed to toggle invites', 'error');
            } finally {
                this.actionLoading = false;
            }
        },
        ...
        async clearRaidFlags() {
            ...
            try {
                ...
                if (response.ok) {
                    this.showNotification('=ƒº¦ Raid flags cleared successfully', 'success');
                    this.loadData();
                } else {
                ...
                this.showNotification('G¥î Failed to clear raid flags', 'error');
            } finally {
                this.actionLoading = false;
            }
        },
        ...
        async emergencyMode() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    this.showNotification(
                        this.emergencyActive ? '=ƒÜ¿ Emergency mode activated' : 'G£à Emergency mode deactivated',
                ...
                this.showNotification('G¥î Failed to toggle emergency mode', 'error');
            } finally {
                this.actionLoading = false;
            }
        },
        ...
        async resolveThreat(threatId) {
            try {
                ...
                if (response.ok) {
                    ...
                    this.showNotification('G£à Threat resolved successfully', 'success');
                } else {
                    throw new Error('Failed to resolve threat');
                }
            } catch (error) {
                console.error('Resolve threat error:', error);
                this.showNotification('G¥î Failed to resolve threat', 'error');
            }
        },
        ...
        toggleAutoRefresh() {
            ...
            if (this.autoRefresh) {
                ...
                this.showNotification('=ƒöä Auto-refresh enabled (30s interval)', 'info');
            } else {
                if (this.autoRefreshInterval) {
                    clearInterval(this.autoRefreshInterval);
                    this.autoRefreshInterval = null;
                }
                this.showNotification('GÅ¦n+Å Auto-refresh disabled', 'info');
            }
        },
        ...
        async finishSetup() {
            ...
            try {
                ...
                if (response.ok) {
                    this.showNotification('=ƒÄë Setup completed successfully!', 'success');
                ...
                this.showNotification('G¥î Setup failed. Please try again.', 'error');
            } finally {
        ...
        async updateSecuritySettings() {
            try {
                ...
                if (response.ok) {
                    this.showNotification('GÜÖn+Å Security settings updated', 'success');
                } else {
                    throw new Error('Failed to update settings');
                }
            } catch (error) {
                console.error('Update settings error:', error);
                this.showNotification('G¥î Failed to update settings', 'error');
            }
        },
        ...
        async updateBotSettings() {
            try {
                ...
                if (response.ok) {
                    this.showNotification('=ƒñû Bot settings updated', 'success');
                } else {
                    throw new Error('Failed to update bot settings');
                }
            } catch (error) {
                console.error('Update bot settings error:', error);
                this.showNotification('G¥î Failed to update bot settings', 'error');
            }
        },
        ...
        async updateApiKeys() {
            try {
                ...
                if (response.ok) {
                    this.showNotification('=ƒöæ API keys updated', 'success');
                } else {
                    throw new Error('Failed to update API keys');
                }
            } catch (error) {
                console.error('Update API keys error:', error);
                this.showNotification('G¥î Failed to update API keys', 'error');
            }
        },
        ...
        async exportLogs() {
            try {
                ...
                if (response.ok) {
                    ...
                    this.showNotification('=ƒôü Logs exported successfully', 'success');
                } else {
                    throw new Error('Failed to export logs');
                }
            } catch (error) {
                console.error('Export logs error:', error);
                this.showNotification('G¥î Failed to export logs', 'error');
            }
        },
        ...
        async exportSettings() {
            ...
            this.showNotification('=ƒÆ+ Settings exported successfully', 'success');
        },
        ...
        async clearLogs() {
            try {
                ...
                if (response.ok) {
                    this.securityLogs = [];
                    this.showNotification('=ƒº¦ Logs cleared successfully', 'success');
                } else {
                    throw new Error('Failed to clear logs');
                }
            } catch (error) {
                console.error('Clear logs error:', error);
                this.showNotification('G¥î Failed to clear logs', 'error');
            }
        },
        ...
        async resetSettings() {
            try {
                ...
                if (response.ok) {
                    ...
                    this.showNotification('=ƒöä Settings reset to defaults', 'success');
                } else {
                    throw new Error('Failed to reset settings');
                }
            } catch (error) {
                console.error('Reset settings error:', error);
                this.showNotification('G¥î Failed to reset settings', 'error');
            }
        },
            ...
            try {
                ...
                ws.onmessage = (event) => {
                    ...
                    if (data.type === 'security_update') {
                        ...
                        this.showNotification(`=ƒÜ¿ ${data.message}`, 'warning');
