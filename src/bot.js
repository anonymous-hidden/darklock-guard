...
class SecurityBot {
    ...
    async initialize() {
        try {
            ...
            // Initialize Server Backup System (used by /serverbackup commands and dashboard)
            try {
                this.serverBackup = new ServerBackupSystem(this);
                await this.serverBackup.initialize();
                this.client.serverBackup = this.serverBackup;
                this.logger.info('   ✅ Server Backup System initialized');
            } catch (err) {
                this.logger.warn('   ⚠️ Server Backup System failed to init:', err?.message || err);
                this.serverBackup = null;
                this.client.serverBackup = null;
            }
