 ...
 *
 * Each entry describes a first-class Nova widget that ships in the app
...
export const BUILTIN_WIDGETS = [
  { id: 'nova-call',     name: 'Call Nova',      icon: '☎',  accent: 'ok',      tags: ['voice','ai'],      description: 'Voice call with Nova — speak and hear replies in real time.', component: NovaCallWidget,      w: 380, h: 520 },
  { id: 'nova-chat',     name: 'Chat with Nova', icon: '✦',  accent: 'accent',  tags: ['chat','ai'],       description: 'Quick chat with Nova in a docked panel.',               component: NovaChatWidget,      w: 420, h: 520 },
  ...
  { id: 'notes',         name: 'Notes',          icon: '✎',  accent: 'ok',      tags: ['notes'],           description: 'Markdown notes Nova can read, write and edit.',         component: NotesWidget,         w: 720, h: 520 },
  ...
  { id: 'calendar',      name: 'Calendar',       icon: '📅', accent: 'accent',  tags: ['time','plan'],     description: 'Local calendar Nova can read and write to.',            component: CalendarWidget,      w: 460, h: 520 },
  { id: 'emotions',      name: 'Mood Journal',   icon: '💭', accent: 'accent',  tags: ['mood','wellbeing'],'description': 'Track your emotions over time — Nova logs them too.', component: EmotionWidget,       w: 460, h: 540 },
